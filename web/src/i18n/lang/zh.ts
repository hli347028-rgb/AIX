export default {
  common: {
    ...
    error: '错误',
    contractVerifying: '加载账户中',
    loadingAccount: '加载账户中',
    accountLoading: '账户资料加载中',
  ...
  index: {
    ...
    communitySubsidyRule: '社区补贴：后台开通后显示；下级 USDT 充值按 5%/10%/15% 级差发放；充值人自身档位不阻断直推上级，中间下级同档或更高会阻断更上级',
  ...
  community: {
    ...
    areaUsdtIn: 'USDT认购',
    areaWinIn: 'WIN认购',
    areaExchangeWin: '交易所划转',
    areaRewardIn: '复投认购',
    areaFundingToggle: '展开或收起资金构成',
    winRechargeSource: '来源',
    winSourceChain: '充值',
    winSourceExchange: '交易所划转',
  ...
  transfer: {
    ...
    exchangeHint: '将 AIX-USDT 划转至已绑定的交易所地址；地址绑定后不可更改',
    exchangeMinHint: '单笔最低 {min} AIX-USDT',
    exchangeBindAddress: '交易所划转地址',
    exchangeBindPlaceholder: '请输入交易所收款地址（绑定后不可更改）',
    exchangeBindHint: '首次划转需绑定交易所地址，绑定后不可更改，且不可与其他用户重复',
    exchangeBindLockedHint: '该地址已绑定，不可更改',
    invalidExchangeAddress: '交易所划转地址无效',
  ...
  announcement: {
    ...
    loading: '加载中…',
    empty: '暂无公告',
    fetchFailed: '获取公告失败', important: '重要公告', latest: '最新公告', notice: '公告通知', details: '公告详情', close: '关闭公告', readBeforeConfirm: '请翻完所有公告后再确认', imageAlt: '公告图片',
