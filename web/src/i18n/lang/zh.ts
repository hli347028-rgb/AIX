export default {
  ...
  index: {
    ...
    managementRewardRule: '管理奖：A1–A10 级差；可释放进奖励钱包，超出出局帽进溢出，下次认购再释放',
  ...
  community: {
    ...
    usdtAmount: '充值USDT金额', brc20Amount: 'BRC20 数量'
  },
  count: {
  ...
  node: {
    ...
    winAReferralTip: '使用 WIN-A 认购不产生直推奖、管理奖与 AIX-USDT，仅计入本人订单与团队业绩。',
    fundingSource: '资金来源',
    rechargeSource: '充值',
    rewardSource: '奖励',
    winSource: 'WIN',
