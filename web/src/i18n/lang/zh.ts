export default {
  common: {
    ...
    days: '{count} 天', retry: '重试', loadFailed: '加载失败，请稍后重试'
  },
  index: {
    ...
    managementRewardRule: '管理奖：等级由小区业绩决定；大区与小区认购均可产生级差奖励，A1–A10 级差进奖励钱包',
  ...
  node: {
    ...
    rechargeWallet: '充值钱包',
    rewardWallet: '奖励钱包',
    referralRewardTip: '仅「充值钱包」报单产生动态收益；奖励钱包报单不产生动态收益。',
    winReferralTip: '使用 WIN 认购等同充值钱包报单，按 WIN 现价折算 USDT 本金，产生动态收益。',
    winAReferralTip: '使用 WIN-A 认购不产生动态收益、管理奖与 AIX-USDT，仅计入本人订单与团队业绩。',
    fundingSource: '资金来源',
    rechargeSource: '充值',
    rewardSource: '奖励',
    winSource: 'WIN',
    ...
    winAPay: 'WIN-A 认购',
    winAPayNow: 'WIN-A 支付',
    winAPaySuccess: 'WIN-A 认购成功',
    winAPayFailed: 'WIN-A 认购失败',
    winAPriceMissing: 'WIN-A 价格未配置',
    winAPayHint: '当前 WIN-A 价格 {price} USDT；本档约需 {cost} WIN-A',
    customWinACostHint: '自定义金额约需 {cost} WIN-A',
    insufficientWinA: 'WIN-A 余额不足',
    reportNow: '立即铸造',
    reinvestNow: '立即复投',
    confirmReport: '确认报单 {amount} USDT？',
    confirmReinvest: '确认复投 {amount} USDT？',
    confirmWinPay: '确认使用约 {cost} WIN 支付 {amount} USDT？',
    confirmWinAPay: '确认使用约 {cost} WIN-A 支付 {amount} USDT？',
    mixPay: '混合报单',
    mixPayNow: '混合支付',
    mixPaySuccess: '混合报单成功',
    mixPayFailed: '混合报单失败',
    mixPayTip: '混合报单固定为 WIN + WIN-A：先选报单金额，再填 WIN 数量，WIN-A 自动补齐剩余等值。',
    mixWinAmount: 'WIN 数量',
    mixWinAmountPlaceholder: '输入 WIN 支付数量',
    mixWinAAmount: 'WIN-A（自动）',
    mixRemainHint: '剩余约 {usdt} USDT → {cost} {unit}',
    mixInvalidAmount1: 'WIN 数量须大于0且等值小于报单本金',
    confirmMixPay: '确认混合报单 {amount} USDT？\nWIN: {amt1}\nWIN-A: {amt2}',
    mixSourceRechargeWin: '充值+WIN',
    mixSourceRechargeWinA: '充值+WIN-A',
    mixSourceWinWinA: 'WIN+WIN-A',
    mixSourceWinRecharge: 'WIN+充值',
    mixSourceWinARecharge: 'WIN-A+充值',
    ...
    subscribeStep: '认购金额必须是 {step} 的倍数',
  ...
  withdraw: {
    ...
    aixExchangeHint: 'AIX 不可直接提现，请先兑换为可提 U 余额',
    winWithdrawDisabled: 'WIN 提现已关闭',
    toAddress: '提现地址',
    toAddressShort: '地址',
  ...
  recharge: {
    ...
    minWinARecharge: '最低充值 {amount} WIN-A',
    minWinARechargeError: 'WIN-A 充值数量不能小于 {amount}',
    enterWinInteger: '请输入整数份数',
    enterWinAInteger: '请输入整数份数',
    nativeWinBalance: '链上 WIN 余额',
    winPayable: '应付 {num} WIN',
    winAPayable: '应付 {num} WIN-A',
    ...
    winARechargeSuccess: 'WIN-A 充值成功',
    winARechargePending: '链上充值成功，WIN-A 余额入账中请稍后刷新',
    winARechargeClosed: '暂未开放',
    txHash: '交易哈希',
    winRecordIndex: '序号',
    ...
    statusRejected: '已拒绝',
    date: '日期',
    amount: '金额', balance: 'USDT充值余额', currentRechargeBalance: '当前USDT充值余额',
  ...
  wallet: {
    ...
    withdrawableAix: '可提 AIX', aixBalance: 'AIX 余额', winBalance: 'WIN 余额', winRechargeBalance: 'WIN 充值余额', usdtWithdrawable: '可提 U 余额', rawNewBalance: '代币余额', exchange: '兑换', directReferralReward: '直推奖励',
