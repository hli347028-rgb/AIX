export default {
  ...
  community: {
    ...
    downlineRechargeAmount: '하위 충전 금액',
  ...
  node: {
    ...
    statusCompleted: '완료',
    statusPending: '대기 중',
    minSubscribeAmount: '인수 금액은 {amount} {unit} 이상이어야 합니다',
  ...
  withdraw: {
    ...
    insufficientWin: 'WIN 잔액이 부족합니다',
    insufficientSdt: 'AIX-USDT 잔액이 부족합니다',
