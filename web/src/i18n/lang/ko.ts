...
const local = {
  common: {
    ...
    inviterNotActivated: '해당 사용자는 활성화되지 않았습니다',
    invalidInviteCode: '유효하지 않은 초대 코드',
    userLocked: '사용자가 잠겼습니다',
    authRejected: '지갑 연결 또는 서명이 취소되었습니다. 다시 시도하세요.',
    walletDisconnected: '지갑 연결이 끊겼습니다. 연결 후 다시 시도하세요.',
    inviteCancelled: '초대 코드 입력이 취소되었습니다. 다시 시도하세요.',
    error: '오류',
    ...
    close: '닫기',
    protocol: '프로토콜', gotIt: '알겠습니다', languageSwitch: '언어 변경', switchWallet: '지갑 전환', back: '뒤로', backHome: '홈으로 돌아가기',
    days: '{count}일', retry: '다시 시도', pageNavigation: '페이지 탐색', openNavigation: 'AIX 기능 메뉴 열기', expandSubordinates: '하위 구성원 펼치기', collapseSubordinates: '하위 구성원 접기', explore: '탐색'
  },
  home: {
    experienceAria: 'AIX 5장 시공간 거래 경험', openingKicker: '다음 좌표', openingPrefix: '지금,', openingTitle: '미래로 진입', openingHint: '스크롤 · 스와이프 · 진입',
    futureTitle: 'AI 클라우드 예측 금융', futureEmphasis: '새로운 영역', futureLead: '블록체인 인프라에서 AI 예측 금융으로, WIN 생태계에서 첫 핵심 WIN/AIX 거래쌍으로. 차세대 Web3는 기존 자산 거래를 넘어 미래에 대한 판단을 거래하는 방법을 탐구합니다.',
    futureStory1: '블록체인이 응용 시대로, AI가 지능형 의사결정 시대로 진입하면서 WIN Chain은 FutureFi와 첫 핵심 클라우드 예측 프로젝트를 선보입니다.', futureStory2: 'AIX는 새로운 생태계 자산을 넘어 WIN Chain이 AI + Prediction + DeFi로 나아가는 전략적 관문입니다.',
    protocolAria: 'FutureFi 프로토콜 구성', predictionTrading: '지능형 예측 거래', futureProtocol: '미래 금융 프로토콜', chainInfrastructure: '온체인 인프라', flow: '현실 이벤트 입력 → AI와 집단지성 가격 결정 → 오라클 검증 → 온체인 결제', viewNarrative: '스토리 보기',
    marketDescription: '실시간 가격, 24H 시세, 거래량과 다중 주기 캔들 차트를 제공합니다. 이 장에서 주기를 바꾸고 OHLC를 확인하세요.', ecosystemTitle: '신뢰할 수 있는 생태계,', ecosystemEmphasis: '함께 미래를 검증', ecosystemDescription: '거래 인프라, 오라클 네트워크, 퍼블릭 체인과 지갑이 가치 유통 네트워크를 구성합니다.',
    networkStatus: '네트워크 상태', ecosystemPartners: '생태계 기관', settlementNetwork: '결제 네트워크', heroTitle: '미래는,', heroEmphasis: '거래할 수 있습니다', heroDescription: '디지털 문명의 가치 추적 네트워크', startNow: '지금 시작', oracle: '오라클', tradingPair: '거래쌍',
    quickLinksAria: '홈 빠른 메뉴', assetRecharge: '자산 충전', predictFuture: '지금 미래 예측', getWinWallet: 'WIN 지갑 받기', currentChapter: '현재 장', controlHint: '휠 / 드래그 / 터치로 이동'
  },
  index: {
    welcomeSubtitle: "세계 최초 FutureFi 생태계",
    welcomeDescription: '디지털 문명의 가치 추적 네트워크',
    welcomeDescription2: '세계 최초 AI 퍼블릭 체인·결제·체인 게임·체인 몰 통합 슈퍼 앱',
    projectInfoTitle1: 'AI 인공지능과 기술 우위성 결합',
  ...
  community: {
    ...
    incomeTotal: '수익 합계', incomeDetail: '수익 상세', teamDataCenter: '팀 데이터 센터', teamDataOverview: '팀 데이터 개요', teamScale: '팀 규모', performanceBreakdown: '실적 구성', incomeAndRewards: '수익 및 보상', zeroAccount: '제로 계정', communitySubsidy: '커뮤니티 지원금',
  ...
  node: {
    ...
    rechargeSource: '충전',
    rewardSource: '보상',
    winSource: 'WIN', winASource: 'WIN-A', unknownSource: '기타 출처', all: '전체',
    mixSourceRechargeWin: '충전 + WIN', mixSourceRechargeWinA: '충전 + WIN-A', mixSourceWinWinA: 'WIN + WIN-A', mixSourceWinRecharge: 'WIN + 충전', mixSourceWinARecharge: 'WIN-A + 충전', mixSourceWinAWin: 'WIN-A + WIN',
    ...
    reportNow: '지금 청약',
    reinvestNow: '지금 재투자',
    confirmReport: '{amount} USDT를 청약하시겠습니까?',
    confirmReinvest: '{amount} USDT를 재투자하시겠습니까?',
    confirmWinPay: '약 {cost} WIN으로 {amount} USDT를 결제하시겠습니까?',
    reportSuccess: '청약 성공',
    reportFailed: '청약 실패',
    ...
    statusComing: '곧 공개',
    subscribeNow: '지금 참여',
    customAmountHint: '사용자 지정 금액（≥ {amount} {unit}）',
  ...
  withdraw: {
    ...
    insufficientWin: 'WIN 잔액이 부족합니다',
    insufficientSdt: 'AIX-USDT 잔액이 부족합니다', insufficientUsdt: '출금 가능 USDT가 부족합니다',
    sdtSubtitle: 'AIX-USDT 출금',
    ...
    statusPending: '처리 중', statusReview: '심사 대기',
  ...
  recharge: {
    ...
    winBalance: 'WIN 잔액', winRechargeBalance: 'WIN 충전 잔액',
    winPrice: 'WIN 가격',
    enterAmount: '금액을 입력하세요',
  ...
  wallet: {
    ...
    withdrawableAix: '출금 가능 AIX', aixBalance: 'AIX 잔액', winBalance: 'WIN 잔액', usdtWithdrawable: '출금 가능 USDT', rawNewBalance: '토큰 잔액', exchange: '교환', directReferralReward: '직접 추천 보상', managementReward: '관리 보상', releasedManagementReward: '지급된 관리 보상', pendingManagementReward: '대기 중인 관리 보상', overflowReward: '초과 보상', totalIncome: '누적 수익',
    aixUsdt: 'AIX-USDT',
    points: '현재 포인트', pointsAll: '누적 포인트', pointsRecords: 'AIX-USDT', noPointsRecords: 'AIX-USDT 기록이 없습니다'
  },
  exchange: {
    title: 'AIX를 USDT로 교환', availableAix: '사용 가능 AIX', currentUsdtWithdrawable: '출금 가능 USDT', exchangeAmount: '교환 수량', all: '전체',
    currentPrice: '현재 교환 가격', currentRate: '교환 환율', rateDetail: '환산 내역',
    aixPrice: 'AIX 가격',
    rateBreakdown: '총량 {gross} USDT, 수수료 {fee}, 순수령 {net} USDT',
    rateShort: '환율', feeRate: '교환 수수료율', priceUnavailable: '교환 가격이 설정되지 않았습니다',
    rateHint: '최종 수령 수량은 교환 완료 시점의 가격과 수수료율을 기준으로 합니다.',
    estimate: '예상 {net} USDT (총량 {gross} USDT, 수수료 {fee} USDT)',
  ...
  announcement: {
    ...
    gotIt: '알겠습니다',
    keepReading: '계속 읽어 주세요',
    acknowledged: '내용을 확인했습니다',
    empty: '공지사항이 없습니다',
  ...
  support: {
    ...
    chatHint: '실시간 상담이 필요하면 클라우드 채팅 고객센터로 문의해 주세요.',
  }
}
