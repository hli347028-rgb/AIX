export default {
  ...
  node: {
    ...
    winPayHint: 'Giá WIN hiện tại {price} USDT',
    ...
    confirmWinPay: 'Xác nhận đăng ký với {cost} WIN?',
    ...
    minSubscribeAmount: 'Số tiền đăng ký không được thấp hơn {amount} {unit}',
  ...
  exchange: {
    ...
    aixPrice: 'Giá AIX', winPrice: 'Giá WIN',
    rateBreakdown: 'Tổng {gross} WIN, phí {fee}, thực nhận {net} WIN',
    ...
    estimate: 'Ước tính {net} WIN (tổng {gross} WIN, phí {fee} WIN)',
    feeDeducted: 'Phí {fee} WIN',
    positiveAmount: 'Số lượng phải lớn hơn 0', insufficientAix: 'Số dư AIX không đủ', netAmountTooSmall: 'Số lượng quá nhỏ, WIN sau phí bằng 0',
