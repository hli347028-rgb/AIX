export default {
  ...
  node: {
    ...
    statusCompleted: '完了',
    statusPending: '保留中',
    minSubscribeAmount: '認購金額は {amount} {unit} 以上である必要があります',
  ...
  withdraw: {
    ...
    insufficientWin: 'WIN残高が不足しています',
    insufficientSdt: 'AIX-USDT残高が不足しています',
  ...
  recharge: {
    ...
    winRechargePending: '充值成功、残高反映までお待ちください',
    txHash: 'Tx ハッシュ',
    winRecordIndex: '番号',
  ...
  exchange: {
    ...
    aixPrice: 'AIX価格', winPrice: 'WIN価格',
    rateBreakdown: '総量 {gross} WIN、手数料 {fee}、純受取 {net} WIN',
    rateShort: 'レート', feeRate: '交換手数料率', priceUnavailable: '交換価格が設定されていません',
    rateHint: '最終受取数量は交換完了時の価格と手数料率に基づきます。',
    estimate: '推定 {net} WIN（総量 {gross} WIN、手数料 {fee} WIN）',
    feeDeducted: '手数料 {fee} WIN',
    positiveAmount: '数量は0より大きい必要があります', insufficientAix: 'AIX残高が不足しています', netAmountTooSmall: '交換数量が小さすぎます。手数料控除後のWINが0になります',
    processing: '交換中...', confirm: '交換を確認',
    records: '交換履歴', noRecords: '交換履歴はありません', priceShort: '価格', success: '交換成功：{amount} WINを受け取りました', failed: '交換に失敗しました。再試行してください'
  },
  payment: {
