...
const minimumNode = 0
const scenes = [
  { id: 'opening', image: '/assets/timeline-00-time-tunnel-v2.webp' },
  { id: 'future', image: '/assets/timeline-04-consensus.webp' },
  { id: 'market', image: '/assets/timeline-03-market.webp' },
  { id: 'ecosystem', image: '/assets/timeline-05-ecosystem.webp' },
  { id: 'hero', image: '/assets/timeline-06-destination.webp' },
]
...
.embedded-panel :deep(.market-stats){
  display:grid;
  grid-template-columns:1fr 1fr;
  width:100%;
}
.embedded-panel :deep(.market-stats>.stat){
  display:flex;
...
.opening-tunnel{
  inset:-5%;
  background-image:url('/assets/timeline-00-time-tunnel-v2.webp');
