...
var adminActionLabels = map[string]string{
	...
	"/api/admin_dhb/exchange_transfer_list": "查看向交易所划转",
	"/api/admin_dhb/reward_list":           "查看奖励记录",
	"/api/admin_dhb/reward_list_export":    "导出奖励记录",
	...
	"/api/admin_dhb/set_frozen_team":             "冻结/解冻团队",
	"/api/admin_dhb/set_exchange_enabled":        "开关用户兑换功能",
	"/api/admin_dhb/set_exchange_enabled_team":   "开关团队兑换功能",
	...
	"/api/admin_dhb/announcement_move":     "调整公告顺序",
